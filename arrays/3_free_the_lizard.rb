...
the variable my_pets is assigned to the range of index locations [2..3] of the variable pets which is assigned the array 
of string elements ['cat', 'dog', 'fish', 'lizard'] which are the string elements 'fish' at index location [2] and 
'lizard' at index location [3].

the variable my_pets is assigned to the range of index locations [2..3] of the variable pets which is assigned the array 
of string elements ['cat', 'dog', 'fish', 'lizard'] which are the string elements 'fish' at index location [2] and 
'lizard' at index location [3] that is my_pets is assigned to the array ['fish', 'lizard'] and then the last element of 
the array is removed and returned which results in the array my_pets being assigned ['fish'].

print to the screen the string "I have a pet #{my_pets[0]}!" which is string interpolation #{my_pets[0]} the variable 
my_pets is assigned to the range of index locations [2..3] of the variable pets which is assigned the array of string 
elements ['cat', 'dog', 'fish', 'lizard'] which are the string elements 'fish' at index location [2] and 'lizard' at index
location [3] that is my_pets is assigned to the array ['fish', 'lizard'] and then the last element of the array is removed
and returned which results in the array my_pets being assigned ['fish'] and [0] references the index location of my_pets 
which is ['fish'][0] which is the string element 'fish' which results in the output: I have a pet fish!
