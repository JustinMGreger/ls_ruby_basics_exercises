...
the variable number is assigned to the integer 7.

if the number is boolean true then print to the screen the string "My favorite number is #{number}." which is string 
