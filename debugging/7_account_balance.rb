...
the variable minus is assigned the sum of the elements of the array of float values that the symbol key 
[:expenses] is assigned within the hash data structure that is selected by the parameter month that is the argument passed 
to the calculate_balance method.
...
the expenses: symbol key is assigned the [ 650, 140, 33.2, 100, 26.9, 78 ] array of float values.
...
the income: symbol key is assigned the [ 1200, 10, 75 ] array of float values.
