...
input is a variable assigned the user input in string form then remove the new line character at the end of the string 
then convert all the upcase letters in the string to the lowercase version of the letters.
.to_sym means convert to symbol form.
this means:
the variable player is assigned the combination of the variable player which is assigned the 
{ strength: 10, dexterity: 10, charisma: 10, stamina: 10 } hash data structure of symbol key integer value pairs which 
contains: the strength: symbol key which is assigned the 10 integer value, the dexterity: symbol key which is assigned the 
10 integer value, the charisma: symbol key which is assigned the 10 integer value, the stamina: symbol key which is 
assigned the 10 integer value and close the hash data structure that is everything after this is outside of the hash data
...
without duplicates where input is a variable assigned the user input in string form which then removes the new line 
character at the end of the string and then converts all the upcase letters in the string to the lowercase version of the
letters which is then converted to symbol form and where the character_classes variable is assigned the outer hash data 
structure which contains: the symbol key warrior: which is assigned { strength:  20 } which is a hash data structure of a 
symbol key integer value pair that is inside of a hash data structure which means this is a nested hash data structure 
which contains the strength: symbol key which is assigned the 20 integer value, the thief: symbol key which is assigned 
{ dexterity: 20 } which is a hash data structure of a symbol key integer value pair that is inside of a hash data 
structure which means this is a nested hash data structure which contains the dexterity: symbol key which is assigned the 
20 integer value, the scout: symbol key which is assigned { stamina: 20 } which is a hash data structure of a symbol key 
integer value pair that is inside of a hash data structure which means this is a nested hash data structure which contains
the stamina: symbol key which is assigned the 20 integer value, the mage: symbol key which is assigned { charisma: 20 } 
which is a hash data structure of a symbol key integer value pair that is inside of a hash data structure which means this
...
outer hash data structure.
this means:
print to the screen the variable player which is assigned the combination of the variable player which is assigned the 
{ strength: 10, dexterity: 10, charisma: 10, stamina: 10 } hash data structure of symbol key integer value pairs which 
contains: the strength: symbol key which is assigned the 10 integer value, the dexterity: symbol key which is assigned 
the 10 integer value, the charisma: symbol key which is assigned the 10 integer value, the stamina: symbol key which is 
assigned the 10 integer value and close the hash data structure that is everything after this is outside of the hash data
structure with the accessed value of the key input in the character_classes outer hash data structure into a new hash 
without duplicates where input is a variable assigned the user input in string form which then removes the new line 
character at the end of the string and then converts all the upcase letters in the string to the lowercase version of the
...
structure which means this is a nested hash data structure which contains the dexterity: symbol key which is assigned the 
20 integer value, the scout: symbol key which is assigned { stamina: 20 } which is a hash data structure of a symbol key 
integer value pair that is inside of a hash data structure which means this is a nested hash data structure which 
contains the stamina: symbol key which is assigned the 20 integer value, the mage: symbol key which is assigned 
{ charisma: 20 } which is a hash data structure of a symbol key integer value pair that is inside of a hash data 
structure which means this is a nested hash data structure which contains the charisma: symbol key which is assigned the
20 integer value and close the character_classes outer hash data structure which means everything after this line is 
outside of the character_classes outer hash data structure.
...
the character_classes variable is assigned the outer hash data structure which contains: the warrior: symbol key which is 
assigned { strength:  20 } which is a hash data structure of a symbol key integer value pair that is inside of a hash 
data structure which means this is a nested hash data structure which contains the strength: symbol key which is 
assigned the 20 integer value, the thief: symbol key assigned { dexterity: 20 } which is a hash data structure of a 
symbol key integer value pair that is inside of a hash data structure which means this is a nested hash data structure
which contains the dexterity: symbol key which is assigned the 20 integer value, the scout: symbol key assigned 
{ stamina: 20 } which is a hash data structure of a symbol key integer value pair that is inside of a hash data structure
which means this is a nested hash data structure which contains the stamina: symbol key which is assigned the 20 integer 
value, the mage: symbol key assigned { charisma: 20 } which is a hash data structure of a symbol key integer value pair 
